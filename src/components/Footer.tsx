...
const socialLinks = [
  {
    id: 'linkedin',
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/bridgemena',
    icon: (
  ...
  },
  {
    id: 'instagram',
    label: 'Instagram',
    href: 'https://instagram.com/bridgemena',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  },
  {
    id: 'facebook',
    label: 'Facebook',
    href: 'https://facebook.com/bridgemena',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
const serviceLinks = [
  { label: 'All Services', href: '/services/profile' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-sm mb-6">
              Simplifying MENA market entry since 2010. We provide end-to-end business setup, visa, HR, and compliance services across UAE and KSA.
            </p>
            {/* Social Media Icons */}
